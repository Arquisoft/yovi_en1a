...
We modify the simulation for managing 100 randomized users interacting with the application at once. After executing, we get 0 KO messages and this results, showing a good management of a bigger user quantity:

image::load-tests-graphs.png[]

image::load-tests.png[]